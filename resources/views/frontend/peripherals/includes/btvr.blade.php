...
<div class=" col-lg-12">
    @foreach($peripherals_vr_core_product as $terminal)
...
<br/>
<div class=" col-lg-12">
    @foreach($peripherals_vr_lite_upgrade_options as $terminal)
        <div class="form-group">
            <label for="inputEmail3"
                   class="col-xs-3 col-sm-4 col-md-4 col-lg-7 control-label">{{ $terminal->item_name }}:</label>
...
<br/>
<div class=" col-lg-12">
    @foreach($peripherals_vr_ent_upgrade_options as $terminal)
        <div class="form-group">
            <label for="inputEmail3"
                   class="col-xs-3 col-sm-4 col-md-4 col-lg-7 control-label">{{ $terminal->item_name }}:</label>
