...
<form id="nav-lan" class="form-horizontal animated fadeIn" action="/bundle_post">
    ...
    <div class="col-md-12 col-lg-12">
        <div class="form-group">
            <label for="inputEmail3" class="col-sm-4 col-lg-5 col-md-4 control-label">
        ...
        <div class="form-group">
            <label for="inputEmail3" class="col-sm-4 col-lg-7 col-md-6 control-label">Type:</label>
        ...
        <div class="form-group">
            <label for="inputEmail3" class="col-sm-4 col-lg-7 col-md-5 control-label">
