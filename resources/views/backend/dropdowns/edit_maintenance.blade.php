...
@section('content')
    <div class="box box-success">
        ...
        <div class="box-body">
            ...
            'method' => 'PATCH',
            'route' => ['admin.dropdown_management.update', 'maintenance' . $maintenance->id],
            'class' => 'form-horizontal']) !!}
            <div class="col-md-6">
                <h2>Edit BT Maintenance:</h2>

                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-4 control-label">Edit Maintenance:</label>
                    <div class="col-sm-5">
