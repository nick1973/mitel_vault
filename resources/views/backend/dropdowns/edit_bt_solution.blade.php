...
@section('content')
    <div class="box box-success">
        ...
        <div class="box-body">
            ...
            {!! Form::model($bt_solution,[
            'method' => 'PATCH',
            'route' => ['admin.dropdown_management.update', 'bt_solution' . $bt_solution->id],
            'class' => 'form-horizontal']) !!}
            <div class="col-md-6">
                <h2>Edit BT Solution:</h2>

                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-4 control-label">Edit Solution:</label>
                    <div class="col-sm-5">
