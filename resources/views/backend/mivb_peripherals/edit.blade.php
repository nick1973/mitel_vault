...
@section('content')
    <ol class="breadcrumb">
        <li><a href="/admin/product_management/mivb_peripherals">Mivb Peripherals</a></li>
    ...
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">Mivb Peripherals</h3>
        ...
        <div class="box-body">
            ...
            {!! Form::model($product,[
            'method' => 'PATCH',
            'route' => ['admin.product_management.mivb_peripherals.update',$product->id],
            'class' => 'form-horizontal']) !!}

            <div class="col-md-6">
                <h2>Mivb Peripherals:</h2>
            ...
            <div class="form-group">
                <div class="col-sm-offset-1 col-sm-10">
                    {!! Form::open([
                    'method' => 'DELETE',
                    'route' => ['admin.product_management.mivb_peripherals.destroy', $product->id,
                    'class' => 'form-horizontal']
                    ]) !!}
