...
@section('page-header')
    ...
    <a class="btn btn-danger pull-right" href="/admin/product_management/mivb_peripherals/create">Add New!</a>
    <br/>
@endsection
    ...
    <div class="box box-success">
        ...
        <div class="box-body">
            <div class="table-responsive">
                <table id="mivb_peripherals" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    <thead>
                    <tr>
                        <th>supplier_ref</th>
                        <th>B-Code</th>
