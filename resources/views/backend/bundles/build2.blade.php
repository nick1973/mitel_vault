                    ...
                    <div id="block" class="box-body">
                        ...
                        <div class="tab-content">
                                    ...
                                    <div class="panel-body" ng-controller="CompanyCtrl">
                                        ...
                                        <table class="table">
                                            ...
                                            <tr ng-repeat="bond in bonds">
                                                <td width="150px">
                                                    <input name="product_id[]" class="form-control users hidden"
                                                           type="text" value="@{{bond.id}}">
                                                ...
                                                <td width="100px">
                                                    <input name="qtys[]" class="form-control users" type="text"
                                                           required>
                                                </td>
                                                <td width="100px">
                            ...
                            <div role="tabpanel" class="tab-pane" id="profile">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body" ng-controller="SoftwareCtrl">
                                        <h2>Add Hardware to: {{ $bundle->name }}</h2>
