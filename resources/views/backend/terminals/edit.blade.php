...
@section('content')
    <ol class="breadcrumb">
        <li><a href="/admin/product_management/terminals">Terminals</a></li>
    ...
    <div class="box box-success">
        ...
        <div class="box-body">
            ...
            {!! Form::model($product,[
            'method' => 'PATCH',
            'route' => ['admin.product_management.terminals.update',$product->id],
            ...
            <div class="form-group">
                <div class="col-sm-offset-1 col-sm-10">
                    {!! Form::open([
                    'method' => 'DELETE',
                    'route' => ['admin.product_management.terminals.destroy', $product->id,
                    'class' => 'form-horizontal']
                    ]) !!}
